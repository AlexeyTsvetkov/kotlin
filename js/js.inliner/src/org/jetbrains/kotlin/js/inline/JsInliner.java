...
public class JsInliner extends JsVisitorWithContextImpl {
    ...
    private void inline(@NotNull JsInvocation call, @NotNull JsContext context) {
        ...
        // wrap result expression, it could be replaced by inliner if needed
        JsExpressionStatement wrapperStatement = new JsExpressionStatement(resultExpression);
        // result expression can contain lambdas that need to be inlined
        accept(wrapperStatement);
        context.replaceMe(wrapperStatement.getExpression());
    }
