...
public fun translateTryExpression(expression: JetTryExpression, context: TranslationContext): JsTry {
    ...
    fun translateCatches(): JsCatch? {
        ...
        fun translateNextCatchClause(currentIf: JsIf, catchClause: JetCatchClause): JsIf {
        ...
        val currentIf = catchClausesStream.fold(resultIf, { (currentIf, catchClause) -> translateNextCatchClause(currentIf, catchClause)} )
