...
class KaptOptions(
    ...
    val discoverProcessorsInCompileClasspath: Boolean
) : KaptFlags {
    ...
    class Builder {
        ...
        var discoverProcessorsInCompileClasspath: Boolean = true
        ...
        fun build(): KaptOptions {
            ...
            return KaptOptions(
                ...
                discoverProcessorsInCompileClasspath = discoverProcessorsInCompileClasspath
            )
        }
    }
}
