...
class GenerateProtoBufPrint {
    companion object {
        val DEST_FILE: File = File("build-common/src/org/jetbrains/kotlin/incremental/ProtoPrintGenerated.kt")
        ...
        fun generate(destFile: File) {
            GeneratorsFileUtil.writeFileIfContentChanged(destFile, GenerateProtoBufPrint().generate())
        }
    }
    ...
    fun generate(): String {
        ...
        p.println()
        p.println("/** This file is generated by org.jetbrains.kotlin.generators.protobuf.GenerateProtoBufPrint. DO NOT MODIFY MANUALLY */")
        p.println()

        p.println("open class ProtoPrintGenerated(val oldNameResolver: NameResolver, val newNameResolver: NameResolver) {")
        p.pushIndent()
    ...
    fun generateForMessage(descriptor: Descriptors.Descriptor, p: Printer) {
        ...
        with (p) {
            println("fun print(message: $typeName) {")
            pushIndent()

            fields.forEach { field -> p.println("// field: ${field.name}}") }
            fields.forEach { field -> p.println("// ext field: ${field.name}}") }
