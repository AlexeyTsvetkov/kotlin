...
@TestMetadata("jps-plugin/testData/incremental/incrementalOff")
@TestDataPath("$PROJECT_ROOT")
@RunWith(JUnit3RunnerWithInners.class)
public class KotlinIncrementalCompilationOffTestGenerated extends AbstractKotlinIncrementalCompilationOffTest {
    ...
    @TestMetadata("turnOffTurnOn")
    public void testTurnOffTurnOn() throws Exception {
        String fileName = JetTestUtils.navigationMetadata("jps-plugin/testData/incremental/incrementalOff/turnOffTurnOn/");
        doTest(fileName);
    }
