...
public class K2JVMCompileMojo extends KotlinCompileMojoBase<K2JVMCompilerArguments> {
    ...
    @Parameter(property = "kotlin.incremental", defaultValue = "false", required = false, readonly = false)
    public boolean isIncremental;

    @Parameter(property = "kotlin.incremental.cache.root", defaultValue = "${project.build.directory}/kotlin-ic", required = false, readonly = false)
    ...
    protected boolean isIncremental() {
        return isIncremental || isIncrementalSystemProperty();
    }
